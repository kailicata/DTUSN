...
"""
modified from mapgen in kwave library
"""
def make_pressure(grid_size: Vector, center: Vector, radius, plot_disc=False) -> kt.NP_ARRAY_BOOL_2D:
    ...
    # define literals 
    MAGNITUDE = -1.19*10**10 #needs more research 
    ...
    # create empty matrix
    disc = np.zeros(grid_size, dtype=float)
